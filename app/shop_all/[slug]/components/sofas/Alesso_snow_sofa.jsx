...
export default function Alesso_snow_sofa({ livingroomdata }) {
  return (
    <div className="pt-[220px] ">
      <div className="flex  justify-center gap-[100px] ">
        <div className="p-5">
          <Image
            src={livingroomdata[3].image}
            className="w-[570px] h-[620px] object-fill   "
            alt="hi"
          ></Image>
          <p className="font-light text-gray-500 pt-2">
            {livingroomdata[3].short_desk}
          </p>
        </div>
        <div className=" w-[500px] p-4">
          <p className="text-[30px] mb-3 font-thin">{livingroomdata[3].name}</p>
          <p className="border-b border-b-gray-400 pb-2 font-bold">
            {livingroomdata[3].price}
          </p>
          ...
          <p className=" font-light text-gray-600  border-b border-b-gray-400 pb-3">
            {livingroomdata[3].log_desk}
          </p>
          <p className=" uppercase font-semibold text-dark pb-2 pt-2">
            Dimensions
          </p>
          <div className="border-b border-b-gray-400 pb-2">
            <p className=" font-thin"> Width: {livingroomdata[3].width}</p>
            <p className=" font-thin"> Depth: {livingroomdata[3].depth}</p>
            <p className=" font-thin"> Height: {livingroomdata[3].height}</p>
          </div>
          ...
          <p className=" font-light text-gray-600 border-b border-b-gray-400 pb-5">
            {livingroomdata[3].careinstructions}
          </p>
