...
export default function Strato103_sofa({ livingroomdata }) {
  return (
    <div className="pt-[220px] ">
      <div className="flex  justify-center gap-[100px] ">
        <div className="p-5">
          <Image
            src={livingroomdata[4].image}
            className="w-[570px] h-[620px] object-fill   "
            alt="hi"
          ></Image>
          <p className="font-light text-gray-500 pt-2">
            {livingroomdata[4].short_desk}
          </p>
        </div>
        <div className=" w-[500px] p-4">
          <p className="text-[30px] mb-3 font-thin">{livingroomdata[4].name}</p>
          <p className="border-b border-b-gray-400 pb-2 font-bold">
            {livingroomdata[4].price}
          </p>
          ...
          <p className=" font-light text-gray-600  border-b border-b-gray-400 pb-3">
            {livingroomdata[4].log_desk}
          </p>
          <p className=" uppercase font-semibold text-dark pb-2 pt-2">
            Dimensions
          </p>
          <div className="border-b border-b-gray-400 pb-2">
            <p className=" font-thin"> Width: {livingroomdata[4].width}</p>
            <p className=" font-thin"> Depth: {livingroomdata[4].depth}</p>
            <p className=" font-thin"> Height: {livingroomdata[4].height}</p>
          </div>
          ...
          <p className=" font-light text-gray-600 border-b border-b-gray-400 pb-5">
            {livingroomdata[4].careinstructions}
          </p>
