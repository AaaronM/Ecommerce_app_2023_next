      ...
      <div className="flex  justify-center gap-[100px] ">
        ...
        <div className=" w-[500px] p-4">
          ...
          <p className=" font-light text-gray-600  border-b border-b-gray-400 pb-3">
            {diningandKitcehn[1].log_desk}
          </p>
          <p className=" uppercase font-semibold text-dark pb-2 pt-2">
            Dimensions
          </p>
          <div className="border-b border-b-gray-400 pb-2">
            <p className=" font-thin"> Width: {diningandKitcehn[1].width}</p>
            <p className=" font-thin"> Depth: {diningandKitcehn[1].depth}</p>
            <p className=" font-thin"> Height: {diningandKitcehn[1].height}</p>
          </div>
          ...
          <p className=" font-light text-gray-600 border-b border-b-gray-400 pb-5">
            {diningandKitcehn[1].careinstructions}
          </p>
